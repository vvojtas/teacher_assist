...
CURRICULUM_REFERENCES = {
    "I.1.2": "Dziecko rozumie podstawowe pojęcia matematyczne, takie jak więcej, mniej, tyle samo.",
    "I.1.3": "Dziecko potrafi klasyfikować przedmioty według jednej cechy.",
    "II.2.1": "Dziecko słucha uważnie i rozumie proste polecenia.",
    "II.2.3": "Dziecko wyraża swoje myśli i uczucia w sposób zrozumiały dla innych.",
    "II.3.1": "Dziecko zapoznaje się z literaturą dziecięcą, słucha uważnie wiersza.",
    "III.1.1": "Dziecko rozwija koordynację wzrokowo-ruchową podczas zabaw plastycznych.",
    "III.2.2": "Dziecko eksperymentuje z różnymi materiałami plastycznymi.",
    "IV.1.1": "Dziecko uczestniczy w zabawach ruchowych, rozwija motorykę dużą.",
    "IV.2.1": "Dziecko potrafi wykonać proste ruchy taneczne do muzyki.",
